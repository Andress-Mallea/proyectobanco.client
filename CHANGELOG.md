...
- Create Angular project with ng: `ng new proyectobanco.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`proyectobanco.client.esproj`).
